...
// Для вставки всередину HTML-атрибута (між лапками "..." або '...') — на відміну від
// escapeHtml(), тут ще й екрануються самі лапки, щоб значення не могло "вирватись"
// з атрибута і дописати свої нові атрибути (напр. onerror="...") в тег.
